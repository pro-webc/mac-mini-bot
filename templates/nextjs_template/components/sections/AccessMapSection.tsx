...
export default function AccessMapSection() {
  return (
    ...
    >
      <h2 id="contact-access-heading" className="text-xl font-bold text-[#0F172A] md:text-2xl">
        所在地マップ
      </h2>
      <p className="mt-3 text-left text-sm leading-relaxed text-[#475569]">
        〒545-0052 大阪市阿倍野区三明町2丁目16-5。Google Maps の埋め込みのみです（画像・プレースホルダは置いていません）。
      </p>
      <div className="mt-6">
        <GoogleMapEmbed
          title="株式会社ワン・ピース 所在地（お問い合わせページ）"
          embedUrl={MAP_EMBED}
        />
      </div>
    </section>
